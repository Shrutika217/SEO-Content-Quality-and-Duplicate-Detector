...
A **Streamlit-based web application** to analyze webpages for **content quality**, **readability**, and **duplicate content detection**. This tool uses a combination of heuristic rules and a machine learning model to classify web content as **Low**, **Medium**, or **High** quality, and also identifies similar pages using TF-IDF and cosine similarity.
